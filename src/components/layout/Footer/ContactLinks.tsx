...
const ContactLinks = () => (
  <div className="flex flex-col space-y-2">
    ...
    <a href="https://dappastra.notion.site/176b2ca320a78049a91aeb91559bc48f" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">General Inquiries</a>
   </div>
);
